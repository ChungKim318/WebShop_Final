		...
		<div class="container">
			<div class="row">
				<div id="logo" class="col-md-3 col-sm-12 col-xs-12">
					<h1>
						<a href="{{asset('/')}}"><img src="img/home/logo.jpg" height="75" width="100"></a>						
				...
				<div id="sidebar" class="col-md-3">
					...
					<div id="banner-l" class="text-center">
						<div class="banner-l-item">
							<a><img src="img/home/banner-l-1.jpg" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
							<a><img src="img/home/banner-l-2.jpg" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
							<a><img src="img/home/banner-l-3.jpg" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
							<a><img src="img/home/banner-l-4.jpg" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
							<a><img src="img/home/banner-l-5.jpg" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
							<a><img src="img/home/banner-l-6.jpg" alt="" class="img-thumbnail"></a>
						</div>
						<div class="banner-l-item">
							<a><img src="img/home/banner-l-7.jpg" alt="" class="img-thumbnail"></a>
						</div>
					</div>
				</div>
				...
				<div id="main" class="col-md-9">
						...
						<div id="demo" class="carousel slide" data-ride="carousel">
							...
							<div class="carousel-inner">
								<div class="carousel-item active">
									<img src="img/home/slide-1.jpg" alt="Los Angeles" height="250" width="900">
								</div>
								<div class="carousel-item">
									<img src="img/home/slide-2.jpg" alt="Chicago" height="250" width="900">
								</div>
								<div class="carousel-item">
									<img src="img/home/slide-3.jpg" alt="New York" height="250" width="900">
								</div>
							</div>
					...
					<div id="banner-t" class="text-center">
						<div class="row">
							...
							<div class="banner-t-item col-md-6 col-sm-12 col-xs-12">
								<a><img src="img/home/banner-t-2.png" alt="" class="img-thumbnail"></a>
							</div>
						</div>					
					</div>
					<!--wrap-->
			...
			<div class="container">
				<div class="row">				
					<div id="logo-f" class="col-md-3 col-sm-12 col-xs-12 text-center">						
						<a href="{{asset('/')}}"><img src="img/home/logo.jpg" height="200" width="200"></a>		
					</div>
