								...
								<div class="col-xs-8">
									...
									<div class="form-group" >
										...
										<select required name="status" class="form-control">
											<option value="1" @if($product->prod_status==1) checkend @endif>Còn hàng</option>
											<option value="0" @if($product->prod_status==0) checkend @endif>Hết hàng</option>
					                    </select>
									</div>
									<div class="form-group" >
										<label>Miêu tả</label>
										...
										<script type="text/javascript">
											...
											filebrowserFlashUploadUrl: '../../editor/public/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images',
											});
										</script>
									</div>
									<div class="form-group" >
